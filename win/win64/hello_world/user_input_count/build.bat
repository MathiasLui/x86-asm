@echo off
REM USAGE:
REM WILL COMPILE AND LINK ALL *.ASM FILES IN THE DIRECTORY TO WIN64 INCLUDING KERNEL32
REM IF AN ARGUMENT IS PASSED, IT WILL BE THE NAME OF THE FINAL EXECUTABLE (WITHOUT FILE EXTENSION)
REM IF NOT GIVEN, NAME WILL BE "output.exe"
REM OBJECT AND EXECUTABLE FILES WILL BE DELETED BEFORE COMPILING
